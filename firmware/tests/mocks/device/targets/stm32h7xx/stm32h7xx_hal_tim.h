...
#if defined(TIM_BDTR_BKBID)
  uint32_t Break2AFMode; /*!< Specifies the alternate function mode of the break2 input.This parameter can be a value of
                            @ref TIM_Break2_Input_AF_Mode */
...
#define TIM_BREAK_SYSTEM_SRAM_PARITY_ERROR                                                                             \
  SYSCFG_CFGR2_SPL /*!< Enables and locks the SRAM_PARITY error signal with Break Input of TIM1/8/15/16/17 */
...
#define IS_TIM_TRIGGER_SELECTION(__SELECTION__)                                                                        \
  (((__SELECTION__) == TIM_TS_ITR0) || ((__SELECTION__) == TIM_TS_ITR1) || ((__SELECTION__) == TIM_TS_ITR2)            \
    || ((__SELECTION__) == TIM_TS_ITR3) || ((__SELECTION__) == TIM_TS_ITR4) || ((__SELECTION__) == TIM_TS_ITR5)        \
    || ((__SELECTION__) == TIM_TS_ITR6) || ((__SELECTION__) == TIM_TS_ITR7) || ((__SELECTION__) == TIM_TS_ITR8)        \
    || ((__SELECTION__) == TIM_TS_ITR12) || ((__SELECTION__) == TIM_TS_ITR13) || ((__SELECTION__) == TIM_TS_TI1F_ED)   \
...
#define IS_TIM_INTERNAL_TRIGGEREVENT_SELECTION(__SELECTION__)                                                          \
  (((__SELECTION__) == TIM_TS_ITR0) || ((__SELECTION__) == TIM_TS_ITR1) || ((__SELECTION__) == TIM_TS_ITR2)            \
    || ((__SELECTION__) == TIM_TS_ITR3) || ((__SELECTION__) == TIM_TS_ITR4) || ((__SELECTION__) == TIM_TS_ITR5)        \
    || ((__SELECTION__) == TIM_TS_ITR6) || ((__SELECTION__) == TIM_TS_ITR7) || ((__SELECTION__) == TIM_TS_ITR8)        \
    || ((__SELECTION__) == TIM_TS_ITR12) || ((__SELECTION__) == TIM_TS_ITR13) || ((__SELECTION__) == TIM_TS_NONE))
